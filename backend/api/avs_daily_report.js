...
cron.schedule('1 7 * * *', async () => {
    ...
    console.log("NHT - AVS - Running data reprod cron job for date:", dateToday, hours, moment().tz('Asia/Bangkok').format("YYYY-MM-DD HH:mm:ss"));
}, {
...
const getDailyReport = async (dateQuery) => {
    ...
    console.log("NHT - AVS - prod...", dateToday, dateTomorrow);
    ...
    try {
        ...
        console.log("NHT - AVS - prod insert error:", error);
        return {
            data: error.message,
            success: true,
